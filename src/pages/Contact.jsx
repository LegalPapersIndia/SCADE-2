...
const Contact = () => {
  ...
  return (
    ...
    >
      ...
      <section className="relative py-20 sm:py-28 lg:py-40 px-6 text-center overflow-hidden">
        <div className="absolute inset-0 opacity-30 pointer-events-none">
          <div className="absolute top-10 sm:top-20 left-1/2 -translate-x-1/2 w-96 sm:w-[1000px] h-96 sm:h-[1000px] bg-cyan-400/20 rounded-full blur-3xl" />
          <div className="absolute bottom-0 right-0 w-80 sm:w-[800px] h-80 sm:h-[800px] bg-blue-600/10 rounded-full blur-3xl" />
        </div>
        ...
        >
          <h1 className="text-5xl sm:text-6xl lg:text-8xl font-bold text-cyan-800 mb-6 leading-tight"
            style={{ fontFamily: "'Playfair Display', serif" }}>
            Let’s Connect
          </h1>
          <p className="text-lg sm:text-2xl lg:text-3xl text-cyan-700 font-light max-w-4xl mx-auto leading-relaxed px-4">
      ...
      {/* Contact Info + Form - Responsive Grid */}
      <section className="py-16 sm:py-20 px-6">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
          ...
          >
            <h2 className="text-4xl sm:text-5xl font-bold text-cyan-800 mb-8 sm:mb-10"
              style={{ fontFamily: "'Playfair Display', serif" }}>
              Get in Touch
            </h2>
            ...
            <div className="space-y-8 sm:space-y-10">
              {[
                { icon: Building, title: "Our Home", content: <>SCADE Store-Studio<br />Housing Board Colony, Hootagalli<br /><span className="font-medium text-cyan-700">Mysore, Karnataka 570018</span></> },
                { icon: Phone, title: "Call or WhatsApp", content: <><a href="tel:+917411532800" className="text-lg text-cyan-700 font-medium">+91 74115 32800</a><br /><a href="https://wa.me/917411532800" target="_blank" rel="noopener" className="text-sm text-cyan-600 underline">Chat on WhatsApp</a></> },
                { icon: Mail, title: "Email Us", content: <a href="mailto:scade.magmist@gmail.com" className="text-lg text-cyan-700">scade.magmist@gmail.com</a> },
                ...
                <div key={i} className="flex items-start gap-5">
                  <div className="w-14 h-14 sm:w-16 sm:h-16 bg-gradient-to-br from-cyan-500 to-blue-600 rounded-2xl flex items-center justify-center shadow-lg flex-shrink-0">
                    <item.icon className="w-7 h-7 sm:w-8 sm:h-8 text-white" />
                  </div>
                  <div>
                    <h3 className="text-lg sm:text-xl font-bold text-cyan-800">{item.title}</h3>
                    <div className="text-gray-700 mt-2 text-sm sm:text-base leading-relaxed">{item.content}</div>
                  </div>
                </div>
              ))}
            </div>

            <div className="mt-10 p-6 sm:p-8 bg-gradient-to-br from-cyan-50 to-blue-50 rounded-2xl border border-cyan-200 text-center">
              <p className="text-cyan-800 font-medium text-base sm:text-lg">
                Looking for <span className="font-bold">Dealership</span> or <span className="font-bold">Collaboration</span>?<br className="hidden sm:block" />
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-5 sm:space-y-6">
              ...
              <button
                ...
                className="w-full bg-gradient-to-r from-cyan-600 to-blue-700 text-white py-5 rounded-2xl font-bold text-lg sm:text-xl shadow-xl hover:shadow-cyan-500/50 hover:scale-105 transition-all flex items-center justify-center gap-3 disabled:opacity-70 disabled:cursor-not-allowed"
              >
                {isSubmitting ? (
                  <>Sending...</>
                ) : (
      ...
      <section className="py-20 sm:py-28 lg:py-32 px-6 bg-gradient-to-b from-white to-cyan-50/60">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-cyan-800 text-center mb-12 sm:mb-16"
            style={{ fontFamily: "'Playfair Display', serif" }}>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
            ...
            >
              <iframe
                ...
                title="SCADE Location - Mysore"
              ></iframe>
            </motion.div>

            <div className="text-left px-4 sm:px-0">
              <h3 className="text-3xl sm:text-4xl font-bold text-cyan-800 mb-6">Made in Mysore, Made for the World</h3>
      ...
      <section className="py-20 sm:py-28 lg:py-32 px-6 bg-gradient-to-r from-cyan-700 via-blue-800 to-cyan-900 text-white">
        <motion.div className="max-w-5xl mx-auto text-center">
          <h2 className="text-5xl sm:text-6xl lg:text-8xl font-bold mb-8 leading-tight"
            style={{ fontFamily: "'Playfair Display', serif" }}>
            Let’s Build the Future Together
          </h2>
          <p className="text-xl sm:text-2xl lg:text-3xl font-light opacity-95 mb-10">
          ...
          <a
            ...
            target="_blank"
            rel="noopener"
            className="inline-flex items-center gap-4 sm:gap-6 bg-gradient-to-r from-amber-500 to-orange-500 text-white px-12 sm:px-16 py-6 sm:py-8 rounded-full text-xl sm:text-2xl font-bold shadow-2xl hover:shadow-amber-500/50 hover:scale-105 transition-all"
          >
            <HeartHandshake className="w-9 h-9 sm:w-10 sm:h-10" />
            Start the Conversation
            <Sparkles className="w-9 h-9 sm:w-10 sm:h-10" />
          </a>
          <p className="mt-10 sm:mt-12 text-lg sm:text-xl opacity-80 italic">
