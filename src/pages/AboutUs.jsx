    ...
    <div className="min-h-screen bg-[#F4F4F4]">
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            <h2 className="text-4xl font-bold text-[#064B39] mb-6">
              Who We Are
            </h2>
            <p className="text-lg text-gray-700 leading-relaxed mb-4">
              Established in 2025 in Mysore, Karnataka, SCADE Store-Studio is
              more than a company — it’s a movement toward healthier living
              through responsible innovation.
            </p>
            <p className="text-lg text-gray-700 leading-relaxed mb-4">
              Founded by two visionary families united by trust, compassion, and
              a shared dream of health innovation, SCADE stands as a symbol of
              unity and purpose. Our foundation rests on a unique blend of
              healthcare professionals and engineers, ensuring every innovation
              is scientifically sound, technologically advanced, and
              purpose-driven.
            </p>
            <p className="text-lg text-gray-700 leading-relaxed">
              We bridge the gap between medical science and technological
              precision to create products that benefit both people and the
              planet.
            </p>
          </div>
      ...
      <section className="py-16 bg-white px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12">
          <div className="bg-[#F4F4F4] rounded-2xl p-10 shadow-lg">
            ...
            <p className="text-lg text-gray-700 leading-relaxed">
              To promote a healthier lifestyle through innovative, sustainable,
              and scientifically proven technologies that improve daily living
              while respecting nature’s balance.
            </p>
          </div>
          <div className="bg-[#F4F4F4] rounded-2xl p-10 shadow-lg">
            <h3 className="text-3xl font-bold text-[#064B39] mb-6">
            ...
            <p className="text-lg text-gray-700 leading-relaxed">
              To become a global leader in health-oriented technology,
              delivering reliable solutions that empower communities and inspire
              sustainable living.
            </p>
          </div>
        </div>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-4xl font-bold text-[#064B39] text-center mb-12">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
            ...
            <div className="order-2 lg:order-1">
              <h3 className="text-3xl font-bold text-[#0A8A67] mb-4">
                💧 Magmist – The Future of Hydration
              </h3>
              <p className="text-lg text-gray-700 leading-relaxed mb-4">
                Our flagship innovation, Magmist is an advanced Atmospheric
                Water Generator (AWG) that produces clean, natural, and alkaline
                water directly from the air. It captures moisture, purifies it
                through multi-stage filtration, and enriches it with essential
                minerals (pH 8–9.5).
              </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <h3 className="text-3xl font-bold text-[#C48A6F] mb-4">
                🌸 Tavarum – Pure Beauty, Naturally
              </h3>
              <p className="text-lg text-gray-700 leading-relaxed mb-4">
                Tavarum is our premium cosmetics line featuring 100% organic,
                sulphate-free, and paraben-free hair essentials. Crafted with
                natural herbs and oils for healthy, beautiful hair.
              </p>
              <ul className="list-disc list-inside text-gray-700 space-y-2">
              ...
              <Link
                to="/tavarum"
                className="mt-6 inline-block bg-[#C48A6F] text-white px-6 py-3 rounded-lg hover:bg-[#b0785f] transition"
              >
                Explore Tavarum →
              </Link>
            </div>
            ...
            {[
              {
                ...
                desc: "Backed by medical and engineering expertise",
              },
              {
                icon: <Beaker className="w-12 h-12" />,
                title: "Precision & Reliability",
                desc: "Rigorously tested for seamless performance",
              },
              {
                icon: <Heart className="w-12 h-12" />,
                title: "Family-Founded",
                desc: "Rooted in trust, care, and community wellness",
              },
              {
                icon: <Flag className="w-12 h-12" />,
                title: "Made in India",
                desc: "Engineered in Mysore for the world",
              },
              {
                icon: <Recycle className="w-12 h-12" />,
                title: "Sustainable",
                desc: "Eco-friendly and zero-waste focused",
              },
              {
                icon: <ShieldCheck className="w-12 h-12" />,
                title: "Customer-Centric",
                desc: "Reliable support and transparent service",
              },
            ].map((item, i) => (
              <div
                key={i}
                className="text-center bg-[#F4F4F4] rounded-xl p-8 shadow-lg hover:shadow-2xl transition"
              >
                <div className="text-[#0A8A67] mb-4 inline-block">
                  {item.icon}
                </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="bg-white rounded-2xl p-10 shadow-xl">
              <h3 className="text-3xl font-bold text-[#064B39] mb-8">
                Visit Us
              </h3>
              <div className="space-y-6">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <a
                    ...
                    className="text-lg hover:text-[#0A8A67] transition"
                  >
                    +91 7411532800
                  </a>
                </div>
              ...
              <p className="mt-8 text-gray-700">
                Proudly made in the cultural heart of India — a city of palaces,
